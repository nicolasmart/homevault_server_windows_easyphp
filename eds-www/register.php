...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_error) && empty($password_error) && empty($confirm_password_error) && empty($user_role_error)) {
        ...
        if (mkdir("users/" . $username) && mkdir("users/" . $username . '/files')) {
            if ($stmt = mysqli_prepare($link, $sql)) {
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="radio" name="user_role" class="form-control" value="admin" checked> Administrator
                <input type="radio" name="user_role" class="form-control" value="standard"> Standard User
            </div>
            <div class="form-group">
