...
$module_info = array(
	...
	"en"	=>	array(
		"Application"	=>	array(
				"Installation date"	=>	"2020-11-30 23:18:12",
		...
		"How to uninstall this module ?"	=>	array(
				"If you want to uninstall this module, you just have to<br />delete the folder"	=>	"<br />[modules folder]\\phpmyadmin470x201130231812",
		),	
	),
	"fr"	=>	array(
		"Application"	=>	array(
				"Date d'installation"	=>	"2020-11-30 23:18:12",
				"Site web"	=>	"<a href='http://www.phpmyadmin.net/' target='_blank'>www.phpmyadmin.net</a>"
		),
		"Comment d&eacute;sinstaller ce module ?"	=>	array(
				"Si vous voulez d&eacute;sinstaller ce module, il suffit de supprimer le r&eacute;pertoire"	=>	"<br />[modules folder]\\phpmyadmin470x201130231812",
		),
	),	
);
